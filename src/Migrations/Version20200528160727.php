 ...
 */
final class Version20200528160727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE legume ADD proteine VARCHAR(255) NOT NULL, ADD lipide VARCHAR(255) NOT NULL, ADD glucide VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE legume DROP proteine, DROP lipide, DROP glucide');
    }
}
