 ...
 */
final class Version20200615073522 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE option_abonnement (option_id INT NOT NULL, abonnement_id INT NOT NULL, INDEX IDX_D87B708BA7C41D6F (option_id), INDEX IDX_D87B708BF1D74413 (abonnement_id), PRIMARY KEY(option_id, abonnement_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
